...
import (
	...
	samplesv1alpha1 "samples.ftc/abstractworkload/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=samples.samples.ftc,resources=abstractworkloads,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=samples.samples.ftc,resources=abstractworkloads/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=samples.samples.ftc,resources=abstractworkloads/finalizers,verbs=update

// Add these RBAC markers to access resources of type Deployment and StatefulSet
...
func (r *AbstractWorkloadReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	obj := &samplesv1alpha1.AbstractWorkload{}
	...
	case samplesv1alpha1.StrStateless:
	...
	case samplesv1alpha1.StrStateful:
	...
	obj.Status.Workload = samplesv1alpha1.CrossNamespaceObjectReference{
...
func (r *AbstractWorkloadReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&samplesv1alpha1.AbstractWorkload{}).
		Owns(&v1.Deployment{}).
		Owns(&v1.StatefulSet{}).
		Watches(
